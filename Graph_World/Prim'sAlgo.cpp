// Hackerearth Implementation --> adjacency list representation
#include <iostream>
#include <vector>
#include <queue>
#include <functional>
...
bool marked[MAX]; // -> precessed vectex
vector <PII> adj[MAX];  // -> adjacency list
...
long long prim(int src)
{
    ...
    PII p;
    Q.push(make_pair(0, src));   // (weight, vertex) format
    while(!Q.empty())
    {
...
*************************************************************************************************************************************************
// Striver Adjacency List representation 
#include<bits/stdc++.h>
using namespace std;
...
// Tech Dose --> Adjacency List Representation
#include<bits/stdc++.h>
using namespace std;
